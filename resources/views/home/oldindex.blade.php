                            ...
                            @foreach ($storeSlide as $store )
                                ...
                                @if ($store)
                                    ...
                                    <a class="carousel-link" href="{{$store['link']}}">
                                        ...
                                        <div class="text-danger carousel-text">Up to {{$store['cashback']?:'$0'}} Cash
                                            Back
                                        </div>
            ...
            <div class="col-md-2-4">
                <div class="deal-card">
                    ...
                    <div class="deal-card-content">
                        ...
                        <small class="text-muted small"><i class="glyphicon glyphicon-time"></i>
                            Expires {{$card->expired_at}}</small>
                        @if($card->code)
                            <p>
                        ...
                        @if($card->code)
                            <div class="form-group">
                                <span>Coupon Code</span><input type="text" name="couponcode"
                                                               class="form-control input-sm couponcode"
                                                               value="{{$card->code}} " readonly
                                                               style="background: #fff">

                            </div>
                        @endif

                        <a target="_blank" href="{{$card->store->sidlink}}" class="btn btn-sm btn-success">Go
                            shopping!</a>
